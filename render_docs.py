...
NAV_ITEMS = [
    ...
    ("TENTH-SLICE-STATUS", "Tenth slice status"),
    ("ECOSYSTEM-PLAIN", "Place care (plain)"),
    ("VISION", "Vision"),
    ...
    ("SIXTH-SLICE-STATUS", "Sixth slice status"),
    ("SEVENTH-SLICE", "Seventh slice"),
...
def update_index() -> None:
    ...
    new_links = """            <div class="links">
        <a href="presence/">Open on your phone</a>
        <a href="docs/PLAIN-LANGUAGE.html">In plain words (start here)</a>
        <a href="docs/ECOSYSTEM-PLAIN.html">Place care (plain words)</a>
        <a href="docs/ANIMAL-PLAIN.html">Pet care (plain words)</a>
        <a href="docs/PHONE-PRESENCE.html">Phone presence</a>
